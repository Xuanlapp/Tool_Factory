...
function CheckSettingsPanel() {
  const [settings, setSettings] = useState<CheckSettings>({ checkImageSize: true, checkTwoSideFaceOffset: false, faceToleranceCm: 0.01, cutToleranceCm: 0.05 });
